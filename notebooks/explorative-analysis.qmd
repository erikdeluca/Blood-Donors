---
title: "Analysis in R"
subtitle: Data wrangling and first GLMs
description: Data visualization and manipulation with tidyverse package. 
author: ["Erik De Luca"]
categories: ["R", "GLM"]
date: 2025-03-30
---
...
recent_donations |> 
  summarise(
    n = n(),
    .by = c(class_year, y_2019)
  ) |> 
  ggplot(aes(x = y_2019, y = class_year, fill = n)) +
  geom_tile()
```
