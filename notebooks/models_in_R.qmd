...
```{r}
zip_path <- here::here("R/fit_glmnet_wf.zip")
rds_path <- here::here("R/fit_glmnet_wf.rds")

unzip(zip_path, exdir = here::here("R"), junkpaths = TRUE)

if (!file.exists(rds_path)) {
  print("⚠️ ERRORE: Il file .rds non è stato trovato!")
  print("Ecco cosa c'è nella cartella R:")
  print(list.files(here::here("R")))
  stop("Interruzione forzata: file mancante.")
}

fit_glmnet_wf <- readRDS(rds_path)
