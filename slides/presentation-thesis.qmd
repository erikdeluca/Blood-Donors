...
![Log-evidence e BIC al variare del numero di parametri](images/bic_plot.png)

## Risultati

::: {layout="[[1,1]]"}

![Occupazione degli stati iniziali](images/hmm_init_white.png)

![Matrice di transizione](images/hmm_trans_white.png)
...
![Coefficienti di $W_\pi$](images/pi_coeff.png){fig-align="center" width=60%}

![Distribuzione di probabilità per stato ed anno di nascita](images/pi_age.png){fig-align="center" width=80%}
...
![Coefficienti di $W_A$](images/trans_coeff.png)
...
![](images/glm_error.png)

![](images/hmm_error_multistate_pred.png)

![](images/hmm_error_onestate_pred.png)
