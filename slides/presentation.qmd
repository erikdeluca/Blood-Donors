...
#| eval: false
#| code-line-numbers: "168-176|178-181|183-194"
...
![](images/hmm_glm_results.png){fig-align="center", width="100"}
...
-('y_pred_hmm') → numero atteso di donazioni per ciascun individuo nell’anno successivo.
    \item \textbf{state\_prob} → distribuzione sugli stati latenti alla fine dell’anno osservato, usata per calcolare la predizione.
$$
