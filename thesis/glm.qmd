...
::: {.callout-tip}
A causa della motlituidine di applicazioni in diversi ambiti della regressione lineare, non c'è una definizione univoca dei suoi elementi. Nel testo sarà comune, quindi, chiamare la variabile $Y$ come variabile dipendente, *outcome*, *output* o *target*. Stesso problema con la variabile, o le variabili, $X$, che possono essere chiamate variabili indipendenti, covariate, *features*, predittori o *inputs*.  
:::
...
::: {.callout-note}
Se si considerasse l'intercetta nella matrice di covariate $X$, allora il termine $\alpha$ scomparirebbe eì si potrebe scrivere l'equazione come 
$$
