...
data |> 
  slice_sample(n = 1, by = c(donation_type, gender)) |> 
  rename_all(\(x) str_replace_all(x, "_", " ") |> str_trunc(11, "center")) |> 
  knitr::kable()
#   gt() |> 
#   tab_header("Sample of the dataset cleaned",
#              "The sample was stratified by the variables donation_type and gender") |> 
...
Questo fenomeno generazionale si può osservare dalla @fig-violin_box_gender dove si osserva unon spostamento nella "gobba" verso l'alto dal 2009 al 2023.
